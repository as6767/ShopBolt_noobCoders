...
<body>
    ...
    <!-- <nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary py-3 fixed-top">
        <div class="container">
          <a href="/Projrct1/home.html">
            <img src="assets/images/logo.png" alt="Logo" width="120" class="nav-logo" >
          </a>
          ...
          <div class="collapse navbar-collapse nav-buttons" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="/Projrct1/Home.html">Home</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/Projrct1/login.html">Sign In</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/Projrct1/login.html">Sign Up</a>
              </li>
            </ul>
            <div class="d-flex">
      ...
      <section id="brand" class="container">
        <div class="row">
            <img class="img-fluid col-lg-3 col-md-6 col-sm-12" src="/Projrct1/assets/images/brand1_sample.jpg" alt="">
            <img class="img-fluid col-lg-3 col-md-6 col-sm-12" src="/Projrct1/assets/images/brand2_sample.jpg" alt="">
            <img class="img-fluid col-lg-3 col-md-6 col-sm-12" src="/Projrct1/assets/images/brand3_sample.jpg" alt="">
            <img class="img-fluid col-lg-3 col-md-6 col-sm-12" src="/Projrct1/assets/images/brand4_sample.jpg" alt="">
        </div>
      </section>
      ...
      <section id="new" class="w-100">
        <div class="row p-0 m-0 ">
            ...
            <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
                <img class="img-fluid" src="/Projrct1/assets/images/brand1.jpg" alt="">
                <div class="details">
            ...
            <!--Two-->
            <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
                <img class="img-fluid" src="/Projrct1/assets/images/brand2.jpg" alt="">
                <div class="details">
            ...
            <!--Three-->
            <div class="one col-lg-4 col-md-12 col-sm-12 p-0">
                <img class="img-fluid" src="/Projrct1/assets/images/brand3.jpg" alt="">
                <div class="details">
            ...
            <div class="container">
                <div class="flex flex-start footer-center">
                    <div class="w-33 mt-2 flex-col gap-2 flex-start">
                        <a href="/"><img src="/Projrct1/assets/images/logo.png" alt="footer-logo"></a>
